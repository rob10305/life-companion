      ...
      <div className="space-y-4 max-w-lg">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5">
          ...
          <div className="flex gap-3 flex-wrap">
            <button
              onClick={exportData}
              className="flex items-center gap-2 px-4 py-2.5 bg-gray-800 hover:bg-gray-700 border border-gray-700 text-white rounded-xl text-sm font-medium transition-colors"
            >
        ...
        {/* Reset */}
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5">
          <h3 className="text-sm font-semibold text-white mb-1">Reset to Defaults</h3>
          <p className="text-xs text-gray-400 mb-4">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5">
          ...
          <div className="space-y-2 text-xs text-gray-400">
            <p><span className="text-gray-300 font-medium">Life Companion</span> — your personal dashboard</p>
