    ...
    <div className="flex flex-col h-full overflow-y-auto">
      <div className="p-6 space-y-6">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-4">
          <h2 className="text-sm font-medium text-gray-300 mb-3">Quick Add Task</h2>
        ...
        {activeProjects.length > 0 && (
          <div>
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-sm font-semibold text-gray-300">Active Projects</h2>
              <button
        ...
        {recentTasks.length > 0 && (
          <div>
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-sm font-semibold text-gray-300">Open Tasks</h2>
              <button
                onClick={() => onNavigate('tasks')}
                className="text-xs text-gray-500 hover:text-gray-300 flex items-center gap-0.5"
              >
