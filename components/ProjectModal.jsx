        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-5">
                ...
                <div className="absolute top-full left-0 mt-2 z-20 bg-gray-800 border border-gray-700 rounded-xl p-2 grid grid-cols-8 gap-1 shadow-xl">
                  {PROJECT_EMOJIS.map(e => (
                    <button
                      ...
                      className={`w-8 h-8 text-lg flex items-center justify-center rounded-lg hover:bg-gray-700 transition-colors ${form.emoji === e ? 'bg-gray-600' : ''}`}
                    >
                      {e}
                    </button>
                  ))}
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="col-span-2">
              ...
              <input
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded-xl px-3 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 text-sm"
              />
            </div>
            <div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="text-xs text-gray-400">Resource Links</label>
              <button
                type="button"
                onClick={addLink}
            ...
            <div className="space-y-3">
              {form.links.length === 0 && (
                <div className="text-center py-4 border border-dashed border-gray-700 rounded-xl text-gray-600 text-sm">
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full bg-gray-800 border border-gray-700 rounded-xl px-3 py-2.5 text-white placeholder-gray-500 text-sm focus:outline-none focus:border-blue-500 resize-none"
            />
          </div>
